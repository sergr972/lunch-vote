package ru.project.lunchvote.web.user;
...
import ru.project.lunchvote.repository.UserRepository;
import ru.project.lunchvote.to.UserTo;
import ru.project.lunchvote.util.JsonUtil;
import ru.project.lunchvote.util.UsersUtil;
import ru.project.lunchvote.web.AbstractControllerTest;

import static org.hamcrest.Matchers.containsString;
import static org.springframework.test.web.servlet.result.MockMvcResultHandlers.print;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.content;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.status;
import static ru.project.lunchvote.web.user.ProfileController.REST_URL;
import static ru.project.lunchvote.web.user.UserTestData.*;
